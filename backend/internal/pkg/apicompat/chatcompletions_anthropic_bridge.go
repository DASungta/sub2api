...
func anthropicUserToChatMessages(raw json.RawMessage) ([]ChatMessage, error) {
	...
	// Remaining text + image blocks → user message. Keep array-form Anthropic
	// content as Chat Completions parts so the direct bridge matches this fork's
	// ResponsesToChatCompletionsRequestWithOptions conversion.
