export default {
    accounts: {
      ...
      types: {
        ...
        apikeyChatCompletionsDesc: '通过完整 URL + API Key 对接任意 OpenAI 兼容的 /v1/chat/completions 端点',
        ...
        chatCompletionsUrlPlaceholder: '完整端点 URL，例如 https://api.deepseek.com/v1/chat/completions',
      ...
      stripReasoningEffortOnCCDesc:
        '当 /responses 请求被转换为 /v1/chat/completions 转发时丢弃 reasoning_effort。适用于拒绝该组合的上游，例如 b.ai。',
